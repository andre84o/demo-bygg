        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              <li><Link href="/tjanster" className="hover:text-amber-500 transition-colors">Badrumsrenovering</Link></li>
              <li><Link href="/tjanster" className="hover:text-amber-500 transition-colors">Köksrenovering</Link></li>
              <li><Link href="/tjanster" className="hover:text-amber-500 transition-colors">Totalrenovering</Link></li>
              <li><Link href="/tjanster" className="hover:text-amber-500 transition-colors">Målning</Link></li>
              <li><Link href="/tjanster" className="hover:text-amber-500 transition-colors">Golvläggning</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-center sm:text-left">
            ...
            <p className="text-slate-500 text-sm mt-1">
              Design & development by <a href="https://www.intenzze.com" target="_blank" rel="noopener noreferrer" className="text-amber-500 hover:text-amber-400 transition-colors">Intenzze</a>
            </p>
          </div>
          <p className="text-slate-500 text-sm">
